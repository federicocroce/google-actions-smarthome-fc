...
exports.login = functions.https.onRequest((request, response) => {
  if (request.method === "GET") {
    ...
    <html>
      ...
      <body>
        <form action="/undefined?code=xxxxxx&state=undefined" method="post">
          <input type="hidden"
...
app.onSync((body) => {
  ...
  // functions.logger.log("Esto es una prueba onSync", body);
...
const queryFirebase = async (deviceId) => {
  ...
  functions.logger.log("Esto es una queryFirebase con deviceValues", {
    deviceValues,
    deviceId,
  });
  ...
  //   ) {
  //     asyncvalue = Object.assign(asyncvalue, {
  //       currentModeSettings: snapshotVal.Modes.currentModeSettings,
  //     });
  //   }
  // }
  ...
  //   if (
  //     Object.prototype.hasOwnProperty.call(
  //       snapshotVal.TemperatureSetting,
  //       "thermostatMode"
  //     )
  //   ) {
  //     asyncvalue = Object.assign(asyncvalue, {
  ...
  //     asyncvalue = Object.assign(asyncvalue, {
  //       thermostatTemperatureSetpoint:
  //         snapshotVal.TemperatureSetting.thermostatTemperatureSetpoint,
  //     });
  //   }
  //   if (
  //     Object.prototype.hasOwnProperty.call(
  ...
  //     asyncvalue = Object.assign(asyncvalue, {
  //       thermostatTemperatureAmbient:
  //         snapshotVal.TemperatureSetting.thermostatTemperatureAmbient,
  //     });
  //   }
  //   if (
  //     Object.prototype.hasOwnProperty.call(
  ...
  //     asyncvalue = Object.assign(asyncvalue, {
  //       thermostatHumidityAmbient:
  //         snapshotVal.TemperatureSetting.thermostatHumidityAmbient,
  //     });
  //   }
  //   if (
  //     Object.prototype.hasOwnProperty.call(
  ...
  //     asyncvalue = Object.assign(asyncvalue, {
  //       thermostatTemperatureSetpointLow:
  //         snapshotVal.TemperatureSetting.thermostatTemperatureSetpointLow,
  //     });
  //   }
  //   if (
  //     Object.prototype.hasOwnProperty.call(
  ...
  //     asyncvalue = Object.assign(asyncvalue, {
  //       thermostatTemperatureSetpointHigh:
  //         snapshotVal.TemperatureSetting.thermostatTemperatureSetpointHigh,
  //     });
  //   }
  // }
  // functions.logger.log("Esto es una queryFirebase", {
  //   asyncvalue,
  //   deviceId,
  // });
  // return asyncvalue;
...
//     datavalue = Object.assign(datavalue, {
//       currentModeSettings: data.currentModeSettings,
//     });
//   }
...
//   }
//   if (
//     Object.prototype.hasOwnProperty.call(data, "thermostatTemperatureSetpoint")
//   ) {
//     datavalue = Object.assign(datavalue, {
...
//   }
//   if (
//     Object.prototype.hasOwnProperty.call(data, "thermostatTemperatureAmbient")
//   ) {
//     datavalue = Object.assign(datavalue, {
...
app.onQuery(async (body) => {
  ...
  functions.logger.log("Esto es una prueba onQuery 1");
  ...
  for (const device of intent.payload.devices) {
    ...
    queryPromises.push(
      ...
      // Add response to device payload
      // (payload.devices[deviceId] = await queryFirebase(deviceId))
    );
  }
    ...
    for (const device of command.devices) {
      for (const execution of command.execution) {
        executePromises.push(
          updateDevice(execution, device.id).then((data) => {
